...
<template>
  <div class="mt-[40px] flex flex-col gap-6">
    <UiCard v-for="i in events" :key="i.id" class="card flex h-52 w-full cursor-pointer items-start gap-4">
      ...
      <div class="flex flex-col">
        ...
        <UiCardContent>
          <span class="text-xs text-zinc-500">Опубликовано: 13.02.2024</span>
        </UiCardContent>
      </div>
    </UiCard>
  </div>
